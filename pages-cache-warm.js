...
window.DosePagesCacheWarm={run:async()=>{await clearRuntimeCaches();await Promise.allSettled(['./supplier-access.js','./russo/russo-auth-guard.js','./russo/index.html'].map(warmOne));}};
